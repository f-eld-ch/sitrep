...
export type FetchIncidentsQuery = {
  incidents: Array<{
    id: string;
    name: string;
    createdAt: string;
    ...
    location: { name: string | null; coordinates: string | null };
  }>;
};
...
export type GetIncidentDetailQuery = {
  incidentsByPk: {
    id: string;
    name: string;
    createdAt: string;
    closedAt: string | null;
    updatedAt: string;
    location: { id: string; name: string | null; coordinates: string | null };
    divisions: Array<{ id: string; name: string; description: string | null }>;
...
export type InsertIncidentMutation = {
  insertIncidentsOne: {
    id: string;
    name: string;
    journals: Array<{ id: string; name: string }>;
    divisions: Array<{ name: string; id: string; description: string | null }>;
    layers: Array<{ name: string; id: string }>;
  } | null;
};
...
export type UpdateIncidentMutation = {
  updateLocationsByPk: { id: string; name: string | null } | null;
  insertDivisions: { affectedRows: number } | null;
  updateIncidentsByPk: {
    id: string;
    name: string;
    journals: Array<{ id: string; name: string }>;
...
export type CloseIncidentMutation = {
  updateJournals: {
    affectedRows: number;
    returning: Array<{ id: string; closedAt: string | null }>;
  } | null;
  updateIncidents: {
    affectedRows: number;
    returning: Array<{ id: string; closedAt: string | null }>;
...
export type DeleteIncidentMutation = {
  updateJournals: {
    affectedRows: number;
    returning: Array<{ id: string; deletedAt: string | null }>;
  } | null;
  updateIncidents: {
    affectedRows: number;
    returning: Array<{ id: string; deletedAt: string | null }>;
...
export type InsertJournalMutation = {
  insertJournalsOne: {
    id: string;
    name: string;
    createdAt: string;
...
export type CloseJournalMutation = {
  updateJournals: {
    affectedRows: number;
    returning: Array<{ id: string; closedAt: string | null }>;
  } | null;
...
export type GetMessagesQuery = {
  ...
  messages: Array<{
    ...
    updatedAt: string;
    deletedAt: string | null;
    triageId: TriageStatusEnum;
    priorityId: PriorityStatusEnum | null;
    medium: MediumEnum | null;
    divisions: Array<{ division: { id: string; name: string; description: string | null } }>;
  }>;
};
...
export type GetMessageForTriageQuery = {
  messagesByPk: {
    id: string;
    content: string;
    sender: string;
    ...
    divisions: Array<{ division: { id: string; name: string; description: string | null } }>;
    journal: {
      incident: { divisions: Array<{ id: string; name: string; description: string | null }> };
    } | null;
  } | null;
};
...
export type InsertMessageMutation = {
  insertMessagesOne: {
    ...
    deletedAt: string | null;
    medium: MediumEnum | null;
    divisions: Array<{ division: { name: string } }>;
  } | null;
};
...
export type SaveMessageTriageMutation = {
  deleteMessageDivision: { affectedRows: number } | null;
  insertMessageDivision: { affectedRows: number } | null;
  updateMessagesByPk: {
    id: string;
    triageId: TriageStatusEnum;
    priorityId: PriorityStatusEnum | null;
  ...
  definitions: [
    {
      ...
      operation: "query",
      name: { kind: "Name", value: "FetchIncidents" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
...
} as unknown as DocumentNode<FetchIncidentsQuery, FetchIncidentsQueryVariables>;
export const GetIncidentDetailDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetIncidentDetail" },
      variableDefinitions: [
        {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "incidentsByPk" },
            arguments: [
              {
                kind: "Argument",
...
} as unknown as DocumentNode<GetIncidentDetailQuery, GetIncidentDetailQueryVariables>;
export const InsertIncidentDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "InsertIncident" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
        ...
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "divisions" } },
          type: {
            kind: "NonNullType",
            type: {
              kind: "ListType",
              type: {
                kind: "NonNullType",
                type: { kind: "NamedType", name: { kind: "Name", value: "DivisionsInsertInput" } },
              },
            },
          },
        },
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "journalName" } },
          type: { kind: "NamedType", name: { kind: "Name", value: "String" } },
        },
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "layerName" } },
          type: { kind: "NamedType", name: { kind: "Name", value: "String" } },
        },
      ],
      selectionSet: {
                              ...
                              fields: [
                                {
                                  ...
                                  value: {
                                    kind: "Variable",
                                    name: { kind: "Name", value: "journalName" },
                                  },
                                },
                              ],
                            },
                              ...
                              fields: [
                                {
                                  ...
                                  value: {
                                    kind: "Variable",
                                    name: { kind: "Name", value: "layerName" },
                                  },
                                },
                              ],
                            },
                        ...
                        fields: [
                          {
                            kind: "ObjectField",
                            name: { kind: "Name", value: "data" },
                            value: { kind: "Variable", name: { kind: "Name", value: "divisions" } },
                          },
                        ],
                      },
                    },
...
} as unknown as DocumentNode<InsertIncidentMutation, InsertIncidentMutationVariables>;
export const UpdateIncidentDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "UpdateIncident" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "incidentId" } },
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "updateLocationsByPk" },
            arguments: [
              {
                kind: "Argument",
          ...
          {
            kind: "Field",
            name: { kind: "Name", value: "insertDivisions" },
            arguments: [
              {
                kind: "Argument",
                  ...
                  fields: [
                    {
                      ...
                      value: { kind: "EnumValue", value: "divisions_name_incident_id_key" },
                    },
                    {
                      kind: "ObjectField",
            ...
            selectionSet: {
              kind: "SelectionSet",
              selections: [{ kind: "Field", name: { kind: "Name", value: "affectedRows" } }],
            },
          },
          {
            kind: "Field",
...
} as unknown as DocumentNode<UpdateIncidentMutation, UpdateIncidentMutationVariables>;
export const CloseIncidentDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "CloseIncident" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "incidentId" } },
        ...
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "closedAt" } },
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "updateJournals" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "where" },
                  ...
                  fields: [
                    {
                      kind: "ObjectField",
                      name: { kind: "Name", value: "closedAt" },
                      value: { kind: "Variable", name: { kind: "Name", value: "closedAt" } },
                    },
                  ],
                },
              },
            ...
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                { kind: "Field", name: { kind: "Name", value: "affectedRows" } },
                {
                  kind: "Field",
...
} as unknown as DocumentNode<CloseIncidentMutation, CloseIncidentMutationVariables>;
export const DeleteIncidentDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "DeleteIncident" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "incidentId" } },
        ...
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "deletedAt" } },
          type: { kind: "NamedType", name: { kind: "Name", value: "timestamptz" } },
        },
      ],
      selectionSet: {
                  ...
                  fields: [
                    {
                      kind: "ObjectField",
                      name: { kind: "Name", value: "deletedAt" },
                      value: { kind: "Variable", name: { kind: "Name", value: "deletedAt" } },
                    },
                  ],
                },
              },
...
} as unknown as DocumentNode<DeleteIncidentMutation, DeleteIncidentMutationVariables>;
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetJournals" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "incidentId" } },
...
} as unknown as DocumentNode<GetJournalsQuery, GetJournalsQueryVariables>;
export const InsertJournalDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "InsertJournal" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "name" } },
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "insertJournalsOne" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "object" },
...
} as unknown as DocumentNode<InsertJournalMutation, InsertJournalMutationVariables>;
export const CloseJournalDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "CloseJournal" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
...
} as unknown as DocumentNode<CloseJournalMutation, CloseJournalMutationVariables>;
export const GetLayersDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetLayers" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "incidentId" } },
...
} as unknown as DocumentNode<GetLayersQuery, GetLayersQueryVariables>;
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "AddFeature" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "layerId" } },
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "uuid" } },
          },
        ...
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "geometry" } },
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "insertFeaturesOne" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "object" },
                value: {
                  ...
                  fields: [
                    ...
                    },
                    {
                      ...
                      value: { kind: "Variable", name: { kind: "Name", value: "geometry" } },
                    },
                    {
                      kind: "ObjectField",
...
} as unknown as DocumentNode<AddFeatureMutation, AddFeatureMutationVariables>;
export const UpdateFeatureDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "UpdateFeature" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "updateFeaturesByPk" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "pkColumns" },
...
} as unknown as DocumentNode<UpdateFeatureMutation, UpdateFeatureMutationVariables>;
export const DeleteFeatureDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "DeleteFeature" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
...
} as unknown as DocumentNode<DeleteFeatureMutation, DeleteFeatureMutationVariables>;
export const AddLayerDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "AddLayer" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "incidentId" } },
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "insertLayersOne" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "object" },
...
} as unknown as DocumentNode<AddLayerMutation, AddLayerMutationVariables>;
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "journalsByPk" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "id" },
          ...
          },
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "senderDetail" } },
                { kind: "Field", name: { kind: "Name", value: "receiverDetail" } },
                {
                  kind: "Field",
                  alias: { kind: "Name", value: "medium" },
                  name: { kind: "Name", value: "mediumId" },
                },
                ...
                { kind: "Field", name: { kind: "Name", value: "triageId" } },
                { kind: "Field", name: { kind: "Name", value: "priorityId" } },
              ],
            },
          },
        ],
...
export const GetMessageForTriageDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetMessageForTriage" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "messagesByPk" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "id" },
...
} as unknown as DocumentNode<GetMessageForTriageQuery, GetMessageForTriageQueryVariables>;
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "InsertMessage" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "journalId" } },
        ...
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "receiverDetail" } },
          type: { kind: "NamedType", name: { kind: "Name", value: "String" } },
        },
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "senderDetail" } },
          type: { kind: "NamedType", name: { kind: "Name", value: "String" } },
        },
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "medium" } },
          type: { kind: "NamedType", name: { kind: "Name", value: "MediumEnum" } },
        },
      ],
      selectionSet: {
        kind: "SelectionSet",
                ...
                value: {
                  ...
                  fields: [
                    ...
                    },
                    {
                      kind: "ObjectField",
                      name: { kind: "Name", value: "mediumId" },
                      value: { kind: "Variable", name: { kind: "Name", value: "medium" } },
                    },
                    {
                      kind: "ObjectField",
                      name: { kind: "Name", value: "senderDetail" },
                      value: { kind: "Variable", name: { kind: "Name", value: "senderDetail" } },
                    },
                    {
                      kind: "ObjectField",
...
} as unknown as DocumentNode<InsertMessageMutation, InsertMessageMutationVariables>;
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "updateMessagesByPk" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "pkColumns" },
...
export const SaveMessageTriageDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "SaveMessageTriage" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "messageId" } },
        ...
        },
        {
          ...
          type: { kind: "NamedType", name: { kind: "Name", value: "PriorityStatusEnum" } },
        },
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "triage" } },
          type: { kind: "NamedType", name: { kind: "Name", value: "TriageStatusEnum" } },
        },
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "messageDivisions" } },
          type: {
            kind: "NonNullType",
            type: {
              kind: "ListType",
              type: {
                ...
                type: {
                  kind: "NamedType",
                  name: { kind: "Name", value: "MessageDivisionInsertInput" },
                },
              },
            },
          },
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "deleteMessageDivision" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "where" },
          ...
          {
            kind: "Field",
            name: { kind: "Name", value: "insertMessageDivision" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "objects" },
                value: { kind: "Variable", name: { kind: "Name", value: "messageDivisions" } },
              },
            ],
            selectionSet: {
              kind: "SelectionSet",
              ...
              },
              {
                ...
                value: {
                  ...
                  fields: [
                    {
                      kind: "ObjectField",
                      name: { kind: "Name", value: "priorityId" },
...
} as unknown as DocumentNode<SaveMessageTriageMutation, SaveMessageTriageMutationVariables>;
