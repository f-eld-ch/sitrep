...
const documents: Documents = {
  ...
  "\n  query GetJournals($incidentId: uuid) {\n    incidents(where: { id: { _eq: $incidentId } }) {\n      id\n      name\n      journals(orderBy: { createdAt: ASC }) {\n        id\n        name\n        createdAt\n        updatedAt\n        closedAt\n        deletedAt\n      }\n    }\n  }\n":
    types.GetJournalsDocument,
  "\n  mutation InsertJournal($name: String!, $incidentId: uuid!) {\n    insertJournalsOne(object: { incidentId: $incidentId, name: $name }) {\n      id\n      name\n      createdAt\n      updatedAt\n      closedAt\n      deletedAt\n    }\n  }\n":
    types.InsertJournalDocument,
  "\n  mutation CloseJournal($journalId: uuid, $closedAt: timestamptz) {\n    updateJournals(where: { id: { _eq: $journalId } }, _set: { closedAt: $closedAt }) {\n      affectedRows\n      returning {\n        id\n        closedAt\n      }\n    }\n  }\n":
    types.CloseJournalDocument,
  "\n  query GetLayers($incidentId: uuid!) {\n    layers(where: { incidentId: { _eq: $incidentId } }) {\n      id\n      name\n      features {\n        id\n        geometry\n        properties\n        createdAt\n        updatedAt\n        deletedAt\n      }\n    }\n  }\n":
    types.GetLayersDocument,
  "\n  mutation AddFeature($layerId: uuid!, $id: uuid!, $geometry: jsonb, $properties: jsonb) {\n    insertFeaturesOne(\n      object: { layerId: $layerId, id: $id, geometry: $geometry, properties: $properties }\n    ) {\n      id\n      geometry\n      properties\n      createdAt\n      updatedAt\n      deletedAt\n    }\n  }\n":
  ...
  "\n    mutation SaveMessageTriage(\n      $messageId: uuid!\n      $priority: PriorityStatusEnum\n      $triage: TriageStatusEnum\n      $messageDivisions: [MessageDivisionInsertInput!]!\n    ) {\n      deleteMessageDivision(where: { messageId: { _eq: $messageId } }) {\n        affectedRows\n      }\n      insertMessageDivision(objects: $messageDivisions) {\n        affectedRows\n      }\n      updateMessagesByPk(\n        pkColumns: { id: $messageId }\n        _set: { priorityId: $priority, triageId: $triage }\n      ) {\n        id\n        divisions {\n          division {\n            name\n          }\n        }\n        triageId\n        priorityId\n      }\n    }\n  ":
    types.SaveMessageTriageDocument,
};
