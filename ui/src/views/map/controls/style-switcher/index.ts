...
export type MaplibreStyleSwitcherOptions = {
    defaultStyle?: string;
    eventListeners?: MaplibreStyleSwitcherEvents;
}

type MaplibreStyleSwitcherEvents = {
...
export class MaplibreStyleSwitcherControl implements IControl {
    private static readonly DEFAULT_STYLE = "Basemap";
    private static readonly DEFAULT_STYLES = [
        { title: "Satelite", uri: "https://vectortiles.geo.admin.ch/styles/ch.swisstopo.imagerybasemap.vt/style.json" },
        { title: "Light Basemap", uri: "https://vectortiles.geo.admin.ch/styles/ch.swisstopo.lightbasemap.vt/style.json" },
        { title: "Basemap", uri: "https://vectortiles.geo.admin.ch/styles/ch.swisstopo.basemap.vt/style.json" },
    ];

    private controlContainer: HTMLElement | undefined;
    private events?: MaplibreStyleSwitcherEvents;
    ...
    constructor(styles?: MaplibreStyleDefinition[], options?: MaplibreStyleSwitcherOptions | string) {
        ...
        this.defaultStyle = defaultStyle || MaplibreStyleSwitcherControl.DEFAULT_STYLE;
