...
type WireGlobalRoleGrant = ListGlobalRolesQuery["globalRoles"][0];
...
export function toGlobalRoleGrant(w: WireGlobalRoleGrant): GlobalRoleGrant {
  return { subject: w.subject, role: w.role, name: w.name, email: w.email };
}
