...
var serveConfigOptions = []configOption{
	...
	uintOption("auto-close-incidents", 30, "Automatically close incidents after this many days (0 disables)"),
	uintOption("auto-archive-incidents", 730, "Archive closed incidents after this many days (0 disables)"),
